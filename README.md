# Bike-Share-Data
Hint.. You can find data.csv in links below.
...
In this project, I will use data provided by [Motivate](https://www.motivateco.com/), a bike share system provider for many major cities in the United States, to uncover bike share usage patterns. I will compare the system usage between three large cities: 
[Chicago](https://www.capitalbikeshare.com/system-data), 
[New York City](https://ride.citibikenyc.com/system-data), 
and [Washington, DC](https://ride.divvybikes.com/system-data).
